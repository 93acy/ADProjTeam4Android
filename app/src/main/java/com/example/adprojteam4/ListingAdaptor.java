...
public class ListingAdaptor extends RecyclerView.Adapter<ListingAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ListingAdaptor.ViewHolder holder, int position) {
        ...
        //holder.hawkerName.setText(hawkerData.get(position).getName());
        holder.hawkerAddress.setText(hawkerData.get(position).get(1));
        holder.hawkerPostalCode.setText(hawkerData.get(position).get(2));
        holder.hawkerStallNo.setText(hawkerData.get(position).get(3));
